    ...
    <div class="relative w-full max-w-[1250px] mx-auto mt-6 px-3 sm:px-4">
      ...
      >
        ...
        >
          ...
          />
          <div class="p-2">
            <p class="text-gray-400 text-xs mb-0.5 truncate">🎬 {{ img.first_air_date }}</p>
            <h5 class="text-white text-sm font-semibold leading-tight truncate">{{ img.name }}</h5>
